...
class PlayerViewModel @Inject constructor(
    ...
    fun updateSubtitleTextSize(size: Int) {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences { it.copy(subtitleTextSize = size) }
        }
    }

    fun updateSubtitleTextColor(color: String) {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences { it.copy(subtitleTextColor = color) }
        }
    }

    fun updateSubtitleBackgroundColor(color: String) {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences { it.copy(subtitleBackgroundColor = color) }
        }
    }
}
